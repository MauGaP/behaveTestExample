...
from Utils import click_element_by_css, validate_alert_message
...
def add_product_to_cart(context):
    click_element_by_css(context, add_to_cart_button_css_selector)
...
def product_page_information_displayed_correctly(context, category):
    ...
    product_name_element_text = locate_element_by_css(context, product_name_css_selector).text
    product_information_from_page_dictionary[product_name] = product_name_element_text
    product_price_element_text = locate_element_by_css(context, product_price_css_selector).text
    product_information_from_page_dictionary[product_price] = product_price_element_text
    product_description_element_text = locate_element_by_css(context, product_description_css_selector).text
